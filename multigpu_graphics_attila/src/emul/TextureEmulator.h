...
public:
    ...
    bool debug[STAMP_FRAGMENTS];
    u32bit threadID[STAMP_FRAGMENTS];
    u32bit batchCounter[STAMP_FRAGMENTS];
    u32bit frameCounter[STAMP_FRAGMENTS];
...
private:
    ...
    u32bit displayScanTileWidth;   /**<  Display tile width in scan tiles.  */
    u32bit displayScanTileHeight;  /**<  Display tile height in scan tiles.  */
...
public:
    ...
    TextureEmulator(u32bit unitID, u32bit stampFrags, u32bit blockDim, u32bit superBlockDim, u32bit anisoAlgo,
    ...
    static void decompressDXT1RGB(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressDXT1RGBA(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressDXT3RGBA(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressDXT5RGBA(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressLATC1(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressLATC1Signed(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressLATC2(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
    ...
    static void decompressLATC2Signed(u8bit *input, u8bit *output, u32bit size, bool debug = false, u32bit debugThread = 0, u32bit unitID = 0);
