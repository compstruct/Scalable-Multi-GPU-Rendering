...
public:
    ...
    SetupTriangle(QuadFloat *vert1, QuadFloat *vert2, QuadFloat *vert3, s32bit vIndex1, s32bit vIndex2, s32bit vIndex3);
   ...
   bool isFirstStamp();
    ...
    void getIndexes(s32bit &vIndex1, s32bit &vIndex2, s32bit &vIndex3);
