...
private:
    ...
    u32bit numGPUs;                 // The bumber of GPUs
    ...
    // Display in multi-GPU architecture
    // In multi-GPU architecture, screen is divided into several small tiles, these tiles are interleaved among different GPUs
    u32bit displayTileWidth;
    u32bit displayTileHeight;
...
public:
    ...
    RasterizerEmulator(u32bit guId, u32bit numGPUs, u32bit activeTriangles, u32bit fragmentAttributes,
        u32bit scanTileW, u32bit scanTileH, u32bit displayTileW, u32bit displayTileH,
	u32bit overTileW, u32bit overTileH, u32bit genTileW, u32bit genTileH,
    ...
    u32bit setup(QuadFloat *vertex1, QuadFloat *vertex2, QuadFloat *vertex3,
		 s32bit vIndex1 = -1, s32bit vIndex2 = -1, s32bit vIndex3 = -1);
    ...
    /**
     *
     * Perform the display test of a triangle in mult-GPU architecture.
     *
     */
    bool multiGPUDisplayTest(u32bit hRes, u32bit vRes, u32bit triangle, u32bit multiGPUExecMode);
