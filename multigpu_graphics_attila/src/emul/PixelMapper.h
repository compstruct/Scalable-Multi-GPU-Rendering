...
private:
    ...
    //  Tiling parameters.
    u32bit displayTileWidth;   /**<  Display tile width in scan tiles.  */
    u32bit displayTileHeight;  /**<  Display tile height in scan tiles.  */
    ...
    u32bit displayTilePixelWidth;   /**<  Width of the display tile in pixels.  */
    u32bit displayTilePixelHeight;  /**<  Height of the display tile in pixels.  */
    u32bit displayTileRowWidth;     /**<  Number of display tiles per display tile row.  */ 
    ...
    u32bit scanTileRowWidth;
    u32bit scanTileColumnHeight;
...
public:
    ...
    void setupDisplay(u32bit xRes, u32bit yRes, u32bit stampW, u32bit stampH,
                      ...
                      u32bit overW, u32bit overH, u32bit displayW, u32bit displayH,
    ...
    /**
     *
     *  Maps the defined pixel position to a display tile.
     *
     *  @param x Pixel horizontal position.
     *  @param y Pixel vertical position.
     *
     *  @return The identifier of the display tile to which the pixel is mapped.
     *
     */
          
    u32bit mapToDisplayTile(u32bit x, u32bit y, u32bit multiGPUExecMode, u32bit numGPUs);
    ...
    /**
     *
     *  Maps the defined pixel address to a display tile.
     *
     *  @param address Pixel address.
     *
     *  @return The identifier of the display tile to which the pixel is mapped.
    ...
    u32bit mapToDisplayTile(u32bit address, u32bit multiGPUExecMode, u32bit numGPUs);
    ...
    void getResolution(u32bit &resWidth, u32bit &resHeight);
    u32bit computeNumOfScanTiles();
    void getOverTileInfo(u32bit &otRowWidth, u32bit &otRows);
