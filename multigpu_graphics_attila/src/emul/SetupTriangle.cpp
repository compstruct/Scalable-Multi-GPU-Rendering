...
SetupTriangle::SetupTriangle(QuadFloat *vattr1, QuadFloat *vattr2, QuadFloat *vattr3,
    s32bit vIndex1_, s32bit vIndex2_, s32bit vIndex3_)
{
    u32bit i;
...
void SetupTriangle::getIndexes(s32bit &index1, s32bit &index2, s32bit &index3)
{
    index1 = vIndex1;
    index2 = vIndex2;
    index3 = vIndex3;
