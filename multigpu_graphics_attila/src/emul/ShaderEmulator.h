...
private:
    ...
    void writeResReg(ShaderInstruction &shInstr, f32bit *f, f32bit *res, bool predicate = true, bool debug = false);
    ...
    void writeResReg(ShaderInstruction &shInstr, s32bit *f, s32bit *res, bool predicate = true, bool debug = false);
    ...
    void writeResReg(ShaderInstruction &shInstr, FixedPoint *f, FixedPoint *res, bool predicate = true, bool debug = false);
    ...
    void writeResult(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul, f32bit *result, bool debug = false);
    ...
    void writeResult(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul, s32bit *result, bool debug = false);
    ...
    void writeResult(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul, FixedPoint *result, bool debug = false);
    ...
    void writeResult(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul, bool result, bool debug = false);
...
public:
    ...
    ShaderEmulator(u32bit unitID, char *name, ShaderModel model, u32bit numThreads = 1, bool storeDecodedInstr = false, TextureEmulator *textEmul = NULL,
