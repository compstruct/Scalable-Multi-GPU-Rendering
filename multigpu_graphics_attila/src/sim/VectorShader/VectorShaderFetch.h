...
private:
    ...
    GPUStatistics::Statistic *vertexProcessCycles;
    GPUStatistics::Statistic *triangleProcessCycles;
    GPUStatistics::Statistic *fragmentProcessCycles;
    ...
    GPUStatistics::Statistic *globalNThReadyAvg;      /**<  Number of ready threads (average).  */
    GPUStatistics::NumericStatistic<u32bit> *globalNThReadyMax;  /**<  Number of ready threads (maximun).  */
    GPUStatistics::NumericStatistic<u32bit> *globalNThReadyMin;  /**<  Number of ready threads (minimun).  */
    ...
    GPUStatistics::Statistic *globalVertexProcessCycles;
    GPUStatistics::Statistic *globalTriangleProcessCycles;
    GPUStatistics::Statistic *globalFragmentProcessCycles;
...
public:
    ...
    VectorShaderFetch(u32bit gpuId, u32bit unitID, ShaderEmulator &shEmu, u32bit nThreads, u32bit resources, u32bit vectorLength,
