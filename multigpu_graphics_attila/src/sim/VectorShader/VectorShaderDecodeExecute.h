...
private:
    ...
    void printShaderInstructionOperands(ShaderInstruction::ShaderInstructionDecoded *shInstrDec, FILE*);
    ...
    void printShaderInstructionResult(ShaderInstruction::ShaderInstructionDecoded *shInstrDec, FILE*);
...
public:
    ...
    VectorShaderDecodeExecute(u32bit gpuId, u32bit unitID, ShaderEmulator &shEmul,
	u32bit vectorThreads, u32bit vectorLength, u32bit vectorALUWidth, char *vectorALUConfig,
