...
private:
    ...
    // In execution round 1 of GPUPD, send primitives to PrimitiveExchanger
    Signal *primitiveExchangerInput;
    Signal *primitiveExchangerRequest;
    ...
    GPUStatistics::Statistic *globalOutputs;  /**<  Number of output triangles.  */
    GPUStatistics::Statistic *globalClipped;  /**<  Number of clipped triangles.  */
...
public:
    ...
    Clipper(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode, u32bit execRound,
	u32bit trianglesCycle, u32bit clipperUnits, u32bit startLatency, u32bit execLatency,
        u32bit bufferSize, u32bit rasterizerStartLat, u32bit rasterizerOutputLat,
	u32bit peStartLat, char *name, Box *parent);
