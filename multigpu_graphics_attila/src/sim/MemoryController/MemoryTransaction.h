...
public:
    ...
    u32bit getDebugThread() { return debugThread; }
    void setDebugThread(u32bit debugThread_) { debugThread = debugThread_; }
    bool getSync() { return sync; }
    void setSync(bool sync_) { sync = sync_; } 
    bool getBlit() { return blit; }
    void setBlit(bool blit_) { blit = blit_; } 
    u64bit getGlobalReqID() { return globalRequestID; }
