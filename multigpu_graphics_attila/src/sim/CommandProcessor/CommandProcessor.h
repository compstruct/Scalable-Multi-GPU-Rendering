...
private:
    ...
    u32bit numDrawCommsInPE;       // Numer of draw commands in primtive exchanger stage of GPUPD
    u32bit numMappedDrawCommsInPE; // Numer of mapped draw commands in primtive exchanger stage of GPUPD
    bool profileVertexes;
    ...
    Signal *peCommSignal;
    Signal *peStateSignal;
    Signal *peMappedDrawCommsSignal;
    Signal *peSyncedDrawCommsSignal;

    bool peSwapCommSent;
    bool hasFreeSpaceInPE;

    bool gpupdBatchEnabled;
    u32bit gpupdBatchThreshold;
    u32bit numTrisSentToPE;
    u32bit numGPUpdBatchInPE;
    ...
    u32bit frame;                       /**<  Current frame.  */
    u32bit geoProcessBatch;
    u32bit fragProcessBatch;
    ...
    bool colorFlushEnd;                 /**<  END command already sent to color write (flush).  */
    bool colorSyncBegan;
    bool blitCommSent;
    bool waitingBlit;
    bool blitSyncBegan;
    ...
    bool flushDelayed;                  /**<  Cycles to wait for HZ updates to finish already set.  */
    bool zSyncBegan;
    ...
    GPUStatistics::Statistic &geoProcessCycles;
    GPUStatistics::Statistic &fragProcessCycles;
    GPUStatistics::Statistic &graphicsPipelineCycles;
    GPUStatistics::Statistic &compCycles;

    GPUStatistics::Statistic &globalRegWrites;    /**<  Number of register writes.  */
    GPUStatistics::Statistic &globalBytesWritten; /**<  Bytes written to memory.  */
    GPUStatistics::Statistic &globalBytesRead;    /**<  Bytes read from memory.  */
    GPUStatistics::Statistic &globalWriteTrans;   /**<  Write transactions.  */
    GPUStatistics::Statistic &globalBatches;      /**<  Number of batches processed.  */
    GPUStatistics::Statistic &globalFrames;       /**<  Number of frames processed (SWAP commands).  */
    GPUStatistics::Statistic &globalBitBlits;     /**<  Number of Bit blit operations. */
    GPUStatistics::Statistic &globalReadyCycles;  /**<  Cycles in ready state.  */
    GPUStatistics::Statistic &globalDrawCycles;   /**<  Cycles in draw state.  */
    GPUStatistics::Statistic &globalEndGeomCycles;/**<  Cycles in end geometry state.  */
    GPUStatistics::Statistic &globalEndFragCycles;/**<  Cycles in end fragment state.  */
    GPUStatistics::Statistic &globalClearCycles;  /**<  Cycles in clear state.  */
    GPUStatistics::Statistic &globalSwapCycles;   /**<  Cycles in swap state.  */
    GPUStatistics::Statistic &globalFlushCycles;   /**<  Cycles in swap state.  */
    GPUStatistics::Statistic &globalSaveRestoreStateCycles;   /**<  Cycles in save/restore state for z/color state.  */
    GPUStatistics::Statistic &globalBitBlitCycles;   /**<  Cycles in framebuffer blitting state. */
    GPUStatistics::Statistic &globalMemReadCycles;    /**<  Cycles in memory read state.  */
    GPUStatistics::Statistic &globalMemWriteCycles;   /**<  Cycles in memory write state.  */
    GPUStatistics::Statistic &globalMemPreLoadCycles; /**<  Cycles in memory preload state.  */
    GPUStatistics::Statistic &globalGeoProcessCycles;
    GPUStatistics::Statistic &globalFragProcessCycles;
    GPUStatistics::Statistic &globalGraphicsPipelineCycles;
    GPUStatistics::Statistic &globalCompCycles;
...
public:
    ...
    CommandProcessor(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode,
	u32bit execRound, bool runaheadInGPUpd, u32bit cpdDrawCommBatchSize,
	bool gpupdBatchEnabled_, u32bit gpupdBatchThreshold_, bool compSchedEnabled,
        TraceDriverInterface *driver, u32bit numVShaders, char **vshPrefixArray,
        u32bit numFShader, char **fshPrefixArray, u32bit numTextureUnits, char **tuPrefixArray,
        u32bit nStampUnits, char **suPrefixes,
        u32bit memorySize, bool pipelinedBatches, bool dumpShaders, bool profileVertexes,
