...
StreamerLoader::StreamerLoader(u32bit gpuId, char *gpuPrefix, u32bit unitId, u32bit idxCycle, u32bit irqSize, u32bit attrCycle,
    ...
    unitID(unitId), Box(gpuId, name, parent)

{
    ...
    cache = new InputCache(
        gpuId,
	unitID,                         /*  The streamer loader unit identifier.  */
    ...
    /*  Create statistics.  */
    indices = &getSM(gpuId).getNumericStatistic("Indices", u32bit(0), "StreamerLoader", prefix);
    transactions = &getSM(gpuId).getNumericStatistic("MemTransactions", u32bit(0), "StreamerLoader", prefix);
    bytesRead = &getSM(gpuId).getNumericStatistic("ReadBytes", u32bit(0), "StreamerLoader", prefix);
    fetches = &getSM(gpuId).getNumericStatistic("Fetches", u32bit(0), "StreamerLoader", prefix);
    noFetches = &getSM(gpuId).getNumericStatistic("NoFetches", u32bit(0), "StreamerLoader", prefix);
    reads = &getSM(gpuId).getNumericStatistic("Reads", u32bit(0), "StreamerLoader", prefix);
    noReads = &getSM(gpuId).getNumericStatistic("NoReads", u32bit(0), "StreamerLoader", prefix);
    inputs = &getSM(gpuId).getNumericStatistic("Inputs", u32bit(0), "StreamerLoader", prefix);
    splitted = &getSM(gpuId).getNumericStatistic("SplittedAttributes", u32bit(0), "StreamerLoader", prefix);
    mapAttributes = &getSM(gpuId).getNumericStatistic("MappedAttributes", u32bit(0), "StreamerLoader", prefix);
    avgVtxSentThisCycle = &getSM(gpuId).getNumericStatistic("AvgVtxSentThisCycle", u32bit(0), "StreamerLoader", prefix);
    stallsShaderBusy = &getSM(gpuId).getNumericStatistic("StallsShaderBusy", u32bit(0), "StreamerLoader", prefix);

    globalIndices = &getSM().getNumericStatistic("Indices", u32bit(0), "StreamerLoader", prefix);
    globalTransactions = &getSM().getNumericStatistic("MemTransactions", u32bit(0), "StreamerLoader", prefix);
    globalBytesRead = &getSM().getNumericStatistic("ReadBytes", u32bit(0), "StreamerLoader", prefix);
    globalFetches = &getSM().getNumericStatistic("Fetches", u32bit(0), "StreamerLoader", prefix);
    globalNoFetches = &getSM().getNumericStatistic("NoFetches", u32bit(0), "StreamerLoader", prefix);
    globalReads = &getSM().getNumericStatistic("Reads", u32bit(0), "StreamerLoader", prefix);
    globalNoReads = &getSM().getNumericStatistic("NoReads", u32bit(0), "StreamerLoader", prefix);
    globalInputs = &getSM().getNumericStatistic("Inputs", u32bit(0), "StreamerLoader", prefix);
    globalSplitted = &getSM().getNumericStatistic("SplittedAttributes", u32bit(0), "StreamerLoader", prefix);
    globalMapAttributes = &getSM().getNumericStatistic("MappedAttributes", u32bit(0), "StreamerLoader", prefix);
    globalAvgVtxSentThisCycle = &getSM().getNumericStatistic("AvgVtxSentThisCycle", u32bit(0), "StreamerLoader", prefix);
    globalStallsShaderBusy = &getSM().getNumericStatistic("StallsShaderBusy", u32bit(0), "StreamerLoader", prefix);
...
//    getName(),cycle, freeInputs, loadInputs, readInputs, fetchInputs);
    ...
    switch(state)
    {
        ...
        case ST_STREAMING:
			...
			input->setBatchCounter(batchCounter);
			input->setFrameCounter(frameCounter);
                    }
                    else
                    {
                        GPU_ASSERT(
			...
			input->setFrameCounter(frameCounter);
                ...
                else
                {
                    ...
                    globalStallsShaderBusy->inc();
                }
            }

            /*  Update statistics.  */
            avgVtxSentThisCycle->incavg(verticesSentThisCycle);
            globalAvgVtxSentThisCycle->incavg(verticesSentThisCycle);
...
void StreamerLoader::processMemoryTransaction(MemoryTransaction *memTrans)
{
    ...
    switch(memTrans->getCommand())
    {
        ...
        case MT_READ_DATA:
            ...
            globalBytesRead->inc(memTrans->getSize());
...
void StreamerLoader::processStreamerCommand(StreamerCommand *streamCom)
{
    ...
    switch(streamCom->getCommand())
    {
	    ...
	    batchCounter = streamCom->getBatchCounter();;
	    frameCounter = streamCom->getFrameCounter();;
...
bool StreamerLoader::allMemoryTransDone() {
    return cache->allMemoryTransDone();
}
