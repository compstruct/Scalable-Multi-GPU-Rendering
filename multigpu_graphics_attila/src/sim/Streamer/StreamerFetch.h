...
private:
    ...
    u32bit primitiveMode;
    u32bit streamStart;             /**<  Start index position (non indexed mode).  */
    u32bit streamStartOfFan;        /**<  Start index position (non indexed mode) of the edge of fan primitive.  */
    ...
    GPUStatistics::Statistic *globalTransactions; /**<  Number of transactions with the Memory Controller.  */
    GPUStatistics::Statistic *globalSentIdx;      /**<  Number of indices sent to Output Cache.  */
...
public:
    ...
    StreamerFetch(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode, u32bit execRound,
	u32bit idxCycle, u32bit indexBufferSize, u32bit outputFIFOSize,
