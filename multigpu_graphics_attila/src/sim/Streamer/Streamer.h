...
private:
    ...
    u32bit startOfFan;                              /**<  Start position from where start streaming data of fan primitive.  */
...
public:
    ...
    Streamer(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode, u32bit execRound,
        u32bit idxCycle, u32bit indexBufferSize, u32bit outputFIFOSize, u32bit outputMemorySize,
