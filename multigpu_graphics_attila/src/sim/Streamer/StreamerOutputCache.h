...
private:
    ...
    GPUStatistics::Statistic *globalHits;     /**<  Number of hits in the Streamer Output Cache.  */
    GPUStatistics::Statistic *globalMisses;   /**<  Number of misses in the Streamer Output Cache.  */
    GPUStatistics::Statistic *globalIndices;  /**<  Number of indices sent to Streamer Output Cache.  */
...
public:
    ...
    StreamerOutputCache(u32bit gpuId, char* gpuPrefix, u32bit idxCycle, u32bit omSize, u32bit vertCycle, u32bit sLoaderUnits, 
