...
private:
    ...
    GPUStatistics::Statistic *globalIndices;        /**<  Indices received from Streamer Output Cache.  */
    GPUStatistics::Statistic *globalShOutputs;      /**<  Number of outputs received from the Shaders.  */
    GPUStatistics::Statistic *globalPaOutputs;      /**<  Number of ouputs sent to Primitive Assembly.  */
    GPUStatistics::Statistic *globalPaRequests;     /**<  Number of outputs requested by Primitive Assembly.  */
    GPUStatistics::Statistic *globalOutAttributes;  /**<  Number of active output attributes per vertex.  */
    GPUStatistics::Statistic *globalAvgVtxShadeLat; /**<  Average shading latency of vertices in the Output FIFO.  */
...
public:
    ...
    StreamerCommit(u32bit gpuId, char *gpuPrefix, u32bit streamLoadUnits,
        u32bit idxCycle, u32bit oFIFOSize, u32bit omSize, u32bit numShaders, u32bit maxOutLat,
