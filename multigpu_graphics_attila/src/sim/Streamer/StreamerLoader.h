...
private:
    ...
    GPUStatistics::Statistic *globalIndices;             /**<  Number of indices (only counts indices that must be loaded) received.  */
    GPUStatistics::Statistic *globalTransactions;        /**<  Number of transactions to Memory Controller.  */
    GPUStatistics::Statistic *globalBytesRead;           /**<  Bytes read from memory.  */
    GPUStatistics::Statistic *globalFetches;             /**<  Number of succesful fetch operations.  */
    GPUStatistics::Statistic *globalNoFetches;           /**<  Number of non succesful fetch operations.  */
    GPUStatistics::Statistic *globalReads;               /**<  Number of succesful read operations.  */
    GPUStatistics::Statistic *globalNoReads;             /**<  Number of non succesful read operations.  */
    GPUStatistics::Statistic *globalInputs;              /**<  Inputs sent to shaders.  */
    GPUStatistics::Statistic *globalSplitted;            /**<  Number of splitted attributes.  */
    GPUStatistics::Statistic *globalMapAttributes;       /**<  Number of attributes mapped to a stream per vertex.  */
    GPUStatistics::Statistic *globalAvgVtxSentThisCycle; /**<  Average vertices sent per cycle to the Shader units.  */ 
    GPUStatistics::Statistic *globalStallsShaderBusy;    /**<  Times the Streamer Loader unit cannot send a ready vertex because Shader Units are busy.  */ 
...
public:
    ...
    StreamerLoader(u32bit gpuId, char *gpuPrefix,
        u32bit unitId, u32bit idxCycle, u32bit irqSize, u32bit attrCycle, u32bit lines, u32bit linesize,
