...
PrimitiveAssemblyInput::PrimitiveAssemblyInput(u32bit ID, QuadFloat *attrib, QuadFloat *attrib3D)
{
    /*  Set vertex parameters.  */
    id = ID;
    attributes = attrib;
    attributes3D = attrib3D;
...
QuadFloat *PrimitiveAssemblyInput::get3DAttributes()
{
    return attributes3D;
}
