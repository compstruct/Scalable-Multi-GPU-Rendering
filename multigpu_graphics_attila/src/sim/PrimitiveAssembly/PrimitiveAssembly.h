...
struct AssemblyQueue
{
    ...
    QuadFloat *attributes3D;  /**<  Vertex attributes in 3D space.  */
};
...
private:
    ...
    // Culling has been done in execution round 1 of GPUPD, so in execution round 2, we skip culling stage
    Signal *rasterizerNewTriangle;
    Signal *rasterizerRequest;
    ...
    u32bit rasterizerStartLat;
    u32bit rasterizerOutputLat;
    ...
    u32bit rasterizerCycles;
    u32bit requestedTriangles;
    ...
    FILE *inputVertexFile;
    u32bit vertexProgramPC;
    bool vertexProgramPCChanged;
    u32bit fragmentProgramPC;
    bool fragmentProgramPCChanged;
    ...
    GPUStatistics::Statistic *globalVertices; /**<  Number of received vertices received from Streamer Commit.  */
    GPUStatistics::Statistic *globalRequests; /**<  Number of requests send to Streamer Commit.  */
    GPUStatistics::Statistic *globalDegenerated;  /**<  Number of degenerated triangles found.  */
    GPUStatistics::Statistic *globalTriangles;    /**<  Number of triangles sent to Clipper.  */
...
public:
    ...
    PrimitiveAssembly(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode, u32bit execRound,
		      u32bit vertCycle, u32bit trCycle, u32bit attrCycle,
		      u32bit vertBustLat, u32bit paQueueSize,
                      u32bit clipStartLat, u32bit rastStartLat, u32bit rastOutputLat, bool profileForSortLast,
