...
private:
    ...
    GPUStatistics::Statistic *globalFetchBankConflicts;   /**<  Counts bank conflicts when fetching.  */
    GPUStatistics::Statistic *globalReadBankConflicts;    /**<  Counts bank conflicts when reading.  */
    GPUStatistics::Statistic *globalMemRequests;          /**<  Memory requests served by the Memory Controller.  */
    GPUStatistics::Statistic *globalMemReqLatency;        /**<  Latency of the memory requests served by the Memory Controller.  */
    GPUStatistics::Statistic *globalPendingRequests;      /**<  Number of memory requests issued to the Memory Controller and not served.  */
    GPUStatistics::Statistic *globalPendingRequestsAvg;   /**<  Average number of memory requests issued to the Memory Controller and not served.  */
...
public:
    ...
    TextureCacheL2(u32bit gpuId, u32bit shaderID, u32bit unitID, u32bit cacheID, u32bit numTextUnits,
        u32bit numWaysL0, u32bit numLinesL0, u32bit lineSizeL0,
   ...
   /**
    ...
    bool read(u64bit address, u32bit way, u32bit line, u32bit size, u8bit *data, bool debug = false, u32bit debugThread = 0);
