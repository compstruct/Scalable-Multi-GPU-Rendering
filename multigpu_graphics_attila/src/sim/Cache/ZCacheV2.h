...
public:
    ...
    ZCacheV2(u32bit gpuId, u32bit numGPUs, u32bit stampId, u32bit numWays, u32bit numLines, u32bit lineSize,
        ...
        u32bit stampUnitStride, u32bit maxBlocks, u32bit blocksCycle, u32bit compCycles, u32bit decompCycles,
    ...
    bool clearForComp(u32bit clearDepthForComp);
    virtual void recordWriteForComp(u32bit rt, u32bit address, bool *culled);
};
