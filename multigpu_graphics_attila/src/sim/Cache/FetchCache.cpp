...
FetchCache::FetchCache(u32bit gpuId, u32bit ways, u32bit lines, u32bit lineBytes, u32bit reqQSize,
    char *fetchCacheName) :

    gpuId(gpuId), requestQueueSize(reqQSize), debugMode(false),
    Cache(ways, lines, lineBytes, CACHE_NONE), shaderID(0), unitID(0)
{
    u32bit i;
    u32bit j;
    ...
    else
    {
        ...
        /*  Create statistics.  */
        fetchMisses = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissesFetch_FC", u32bit(0), "FetchCache", name);
        fetchHits = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("HitsFetch_FC", u32bit(0), "FetchCache", name);
        fetchMissOK = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissOKFetch_FC", u32bit(0), "FetchCache", name);
        fetchMissFail = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailFetch_FC", u32bit(0), "FetchCache", name);
        fetchMissFailReqQ = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailReqQueueFetch_FC", u32bit(0), "FetchCache", name);
        fetchMissFailRes = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailReserveFetch_FC", u32bit(0), "FetchCache", name);
        fetchMissFailMiss = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailMissFetch_FC", u32bit(0), "FetchCache", name);
        allocMisses = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissesAlloc_FC", u32bit(0), "FetchCache", name);
        allocHits = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("HitsAlloc_FC", u32bit(0), "FetchCache", name);
        allocMissOK = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissOKAlloc_FC", u32bit(0), "FetchCache", name);
        allocMissFail = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailAlloc_FC", u32bit(0), "FetchCache", name);
        allocMissFailReqQ = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailReqQueueAlloc_FC", u32bit(0), "FetchCache", name);
        allocMissFailRes = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailReserveAlloc_FC", u32bit(0), "FetchCache", name);
        allocMissFailMiss = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("MissFailMissAlloc_FC", u32bit(0), "FetchCache", name);
        readOK = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("ReadsOK_FC", u32bit(0), "FetchCache", name);
        readFail = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("ReadsFail_FC", u32bit(0), "FetchCache", name);
        writeOK = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("WritesOK_FC", u32bit(0), "FetchCache", name);
        writeFail = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("WritesFail_FC", u32bit(0), "FetchCache", name);
        readBytes = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("ReadBytes_FC", u32bit(0), "FetchCache", name);
        writeBytes = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("WriteBytes_FC", u32bit(0), "FetchCache", name);
        unreserves = &GPUStatistics::StatisticsManager::instance(gpuId).getNumericStatistic("Unreserves_FC", u32bit(0), "FetchCache", name);
        
	globalFetchMisses = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissesFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchHits = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("HitsFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchMissOK = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissOKFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchMissFail = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchMissFailReqQ = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReqQueueFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchMissFailRes = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReserveFetch_FC", u32bit(0), "FetchCache", name);
        globalFetchMissFailMiss = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailMissFetch_FC", u32bit(0), "FetchCache", name);
        globalAllocMisses = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissesAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocHits = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("HitsAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocMissOK = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissOKAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocMissFail = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocMissFailReqQ = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReqQueueAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocMissFailRes = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReserveAlloc_FC", u32bit(0), "FetchCache", name);
        globalAllocMissFailMiss = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("MissFailMissAlloc_FC", u32bit(0), "FetchCache", name);
        globalReadOK = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("ReadsOK_FC", u32bit(0), "FetchCache", name);
        globalReadFail = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("ReadsFail_FC", u32bit(0), "FetchCache", name);
        globalWriteOK = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("WritesOK_FC", u32bit(0), "FetchCache", name);
        globalWriteFail = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("WritesFail_FC", u32bit(0), "FetchCache", name);
        globalReadBytes = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("ReadBytes_FC", u32bit(0), "FetchCache", name);
        globalWriteBytes = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("WriteBytes_FC", u32bit(0), "FetchCache", name);
        globalUnreserves = &GPUStatistics::StatisticsManager::instance().getNumericStatistic("Unreserves_FC", u32bit(0), "FetchCache", name);
    }
	...
	/*  Allocate debug bit (per line).  */
        ...
        GPU_ASSERT(
            if (debugging[i] == NULL)
                panic("FetchCache", "FetchCache", "Error allocating debug bit (per line).");
        )
...
//printf("FetchCache (%s) => Address %x Hit on tag in way = %d line = %d but failed on write mask\n", name, address, way, line);
	...
	if (debug) {
	    ...
	    fprintf(debugfile, "thread %d in cache %d hit while fetching addr 0x%x, way %d line %d offset %lld\n",
...
//printf("FetchCache (%s) => Evicting line at way = %d line = %d | outAddress = %x | inAddress = %x\n", name, way, line, oldAddress, line2address(way, line));
		    ...
		    requestQueue[freeRequest].debugThread = debugThread;
	            ...
	            if (debug) {
	                ...
	                sprintf(filename, "debugVSFInput%d.txt", shaderID);
	                FILE *debugfile = fopen(filename, "a+");
	                fprintf(debugfile, "thread %d in cache %d reserve for addr 0x%x, way %d line %d spill T\n",
...
//printf("FetchCache (%s) => Reserving line at way = %d line = %d | inAddress = %x\n", name, way, line, line2address(way, line));
		    ...
		    requestQueue[freeRequest].debugThread = debugThread;
	            ...
	            if (debug) {
	                ...
	                sprintf(filename, "debugVSFInput%d.txt", shaderID);
	                FILE *debugfile = fopen(filename, "a+");
	                fprintf(debugfile, "thread %d in cache %d reserve for addr 0x%x, way %d line %d spill F\n",
	            	    debugThread, unitID, address, way, line);
	                fflush(debugfile);
	                fclose(debugfile);
	            }
...
bool FetchCache::read(u32bit address, u32bit way, u32bit line, u32bit size, u8bit *data, bool debug, u32bit debugThread)
{
    u32bit i;
    u32bit off;
	...
	if (debug) {
	    ...
	    fprintf(debugfile, "thread %d in cache %d is reading addr 0x%x tag 0x%x offset = %lld\n",
...
bool FetchCache::writeLine(u32bit way, u32bit line, u8bit *linedata)
{
    ...
    if (debugging[way][line]) {
        ...
        sprintf(filename, "debugVSFInput%d.txt", shaderID);
        FILE *debugfile = fopen(filename, "a+");
        fprintf(debugfile, "cache %d writeLine tag 0x%x size %d way %d line %d\n",
                unitID, line2address(way, line), lineSize, way, line);
        for (i = 0; i < lineSize; i++)
