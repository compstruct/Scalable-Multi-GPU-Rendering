...
public:
    ...
    virtual bool fetch(u64bit address, u32bit &way, u32bit &line, u64bit &tag, bool &ready, DynamicObject *source,
		       bool debug = false, u32bit debugThread = 0) = 0;
   ...
   /**
    ...
    virtual bool read(u64bit address, u32bit way, u32bit line, u32bit size, u8bit *data, bool debug = false, u32bit debugThread = 0) = 0;
