...
protected:
    ...
    FifoSchedulerBase(u32bit gpuId, u32bit schedulerId, const char* name, const char* prefix,
		      Box* parent, const ChannelScheduler::CommonConfig& config);
...
private:
    ...
    GPUStatistics::Statistic& globalCSched_IdleCycles;
    GPUStatistics::Statistic& globalCSched_PrevCmdWaitCycles;
    GPUStatistics::Statistic& globalCSched_PrevPageCloseCycles;
    GPUStatistics::Statistic& globalCSched_OpeningPageCycles;
    GPUStatistics::Statistic& globalCSched_AccessingReadDelayCycles; // CAS or WL latency cycles
    GPUStatistics::Statistic& globalCSched_AccessingWriteDelayCycles;
    GPUStatistics::Statistic& globalCSched_AccessingReadDataCycles;
    GPUStatistics::Statistic& globalCSched_AccessingWriteDataCycles;
    ...
    GPUStatistics::Statistic& globalCtrlIdleCyclesStat;

    // Cycles sending a command in the control bus
    GPUStatistics::Statistic& ctrlUsedCyclesStat;

    GPUStatistics::Statistic& globalCtrlUsedCyclesStat;
    ...
    GPUStatistics::Statistic& globalAtorStat; // Active to read penalty cycles
    GPUStatistics::Statistic& globalAtowStat; // Active to write cycles penalty cycles
    GPUStatistics::Statistic& globalAtoaStat; // Active to Active penalty cycles
    GPUStatistics::Statistic& globalPtoaStat; // Precharge to active penalty cycles
    GPUStatistics::Statistic& globalWtorStat; // Write to read penalty cycles
    GPUStatistics::Statistic& globalRtowStat; // Read to write penalty cycles
    GPUStatistics::Statistic& globalWtopStat; // Write to precharge penalty cycles
    GPUStatistics::Statistic& globalAtopStat; // Active to precharge penalty cycles
    GPUStatistics::Statistic& globalRtopStat; // Read to precharge penalty cycles
    GPUStatistics::Statistic& globalRtorStat; // Read to read "penalty" cycles
    GPUStatistics::Statistic& globalWtowStat; // Write to write "penalty" cycles
    ...
    GPUStatistics::Statistic& globalSwitchModeCount; // Statistic counting how much switches from r2w and w2r happen
    ...
    GPUStatistics::Statistic& globalSumPreAct2AccessCycles; // sum of cycles lost between 
     ...
     */
    u32bit fillCommandBuffer(u64bit cycle, const ChannelTransaction* ct); // , PagePolicy policy);
