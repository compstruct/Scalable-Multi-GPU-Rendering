...
private:
    ...
    GPUStatistics::Statistic& globalReadBytesStat; /**< Statistic accumulating read bytes by this channel */
    GPUStatistics::Statistic& globalWriteBytesStat; /**< Statistic accumulating written bytes by this channel */
    ...
    GPUStatistics::Statistic& globalReadCmdStat; /**< Statistic used to count read commands issued to this channel */
    GPUStatistics::Statistic& globalWriteCmdStat; /**< Statistic used to count write commands issued to this channel */
    GPUStatistics::Statistic& globalActiveCmdStat; /**< Statisic used to count active commands issued to this channel */
    GPUStatistics::Statistic& globalPrechargeCmdStat; /**< Statistic used to count precharge commands issued to this channel */
    ...
    */
    ...
    GPUStatistics::Statistic& globalTotalRowHitStat;       /**< Statistic used to count row/page hits */
    GPUStatistics::Statistic& globalReadRowHitStat;   /**< Statistic used to count read row/page hits */
    GPUStatistics::Statistic& globalWriteRowHitStat;  /**< Statistic used to count write row/page hits */
    GPUStatistics::Statistic& globalTotalRowMissStat;      /**< Statistic used to count row/page misses */
    GPUStatistics::Statistic& globalReadRowMissStat;  /**< Statistic used to count read row/page misses */
    GPUStatistics::Statistic& globalWriteRowMissStat; /**< Statistic used to count write row/page misses */
    ...
    PerClientRowHitRatio globalPerClientRowHit[LASTGPUBUS];
...
protected:
    ...
    */
     ...
     */
    ChannelScheduler(u32bit gpuId, u32bit schedulerId, const char* name, const char* prefix, Box* parent, const CommonConfig& config);
