...
std::string ChannelTransaction::toString() const
{
    ...
    ss << "\n" << req->getTransaction()->toString(true);
    return ss.str();
}
...
bool ChannelTransaction::getDebug() const { return req->getTransaction()->getDebug(); }
u32bit ChannelTransaction::getDebugThread() const { return req->getTransaction()->getDebugThread(); }
gpu3d::MemTransCom ChannelTransaction::getCommand() const { return req->getTransaction()->getCommand(); }
std::string ChannelTransaction::getSource() const { return req->getTransaction()->getRequestSourceStr(); }
u32bit ChannelTransaction::getAddress() const { return req->getTransaction()->getAddress(); }
u64bit ChannelTransaction::getGlobalReqID() const { return req->getTransaction()->getGlobalReqID(); }
bool ChannelTransaction::getSync() const { return req->getTransaction()->getSync(); }
bool ChannelTransaction::getBlit() const { return req->getTransaction()->getBlit(); }
