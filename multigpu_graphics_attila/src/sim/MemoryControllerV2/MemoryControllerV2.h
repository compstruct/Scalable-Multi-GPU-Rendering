...
private:
    ...
    u64bit prevMemPreloads;
    u64bit prevMemReads;
    u64bit prevMemWrites;
    ...
    GPUStatistics::Statistic* globalTotalTransStat;
    GPUStatistics::Statistic* globalTotalWriteTransStat;
    GPUStatistics::Statistic* globalTotalReadTransStat;
    GPUStatistics::Statistic* globalTotalWriteBytesStat;
    GPUStatistics::Statistic* globalTotalReadBytesStat;
    ...
    GPUStatistics::Statistic* globalChannelReq_ReadStallCyclesStat;
    GPUStatistics::Statistic* globalChannelReq_WriteStallCyclesStat;
    ...
    struct UnitStatsGroup
    {
        ...
        GPUStatistics::Statistic* globalTrans;
        GPUStatistics::Statistic* globalWriteTrans;
        GPUStatistics::Statistic* globalReadTrans;
        GPUStatistics::Statistic* globalWriteBytes;
        GPUStatistics::Statistic* globalReadBytes;
        GPUStatistics::Statistic* globalAcceptReadCycles;
        GPUStatistics::Statistic* globalAcceptWriteCycles;
        GPUStatistics::Statistic* globalReadServiceAccumTime;
        GPUStatistics::Statistic* globalCompletedReadTrans; // different from readTrans -> readTrans is computed when a request arrive to the MC
        GPUStatistics::Statistic* globalReadServiceTimeAvg; // equivalent to readServiceAccumTime/completedReadTrans 

        void initUnitStatGroup(u32bit gpuId, const std::string& prefix);
    };
    ...
    struct UnitChannelStatsGroup
    {
        ...
        GPUStatistics::Statistic* globalReadBytes;
        GPUStatistics::Statistic* globalWriteBytes;
        GPUStatistics::Statistic* globalReadChannelTransAccumTime;
        GPUStatistics::Statistic* globalCompletedReadChannelTrans;

        void initUnitChannelStatsGroup(u32bit gpuId, const std::string& prefix, const std::string& postfix);
    };
    ...
    GPUStatistics::Statistic* globalPreloadStat;

    // System memory statistics
    GPUStatistics::Statistic* sysBusReadBytesStat;
    GPUStatistics::Statistic* sysBusWriteBytesStat;

    GPUStatistics::Statistic* globalSysBusReadBytesStat;
    GPUStatistics::Statistic* globalSysBusWriteBytesStat;
    ...
    GPUStatistics::Statistic* globalStat_requestBufferAccumSizeStat;
    ...
    GPUStatistics::Statistic* globalStat_avgRequestBufferAllocated;


    GPUStatistics::Statistic* stat_serviceQueueAccumSizeStat;
    GPUStatistics::Statistic* globalStat_serviceQueueAccumSizeStat;
    /**
     * @brief Statistic keeping the service queue's average requests
     */
    GPUStatistics::Statistic* stat_avgServiceQueueItems;
    GPUStatistics::Statistic* globalStat_avgServiceQueueItems;
    ...
    void createUsageSignals(char *gpuPrefix, const MemoryControllerParameters& params);
    // Create I/O signals (input/output buses)
    void createIOSignals(char *gpuPrefix); 

    void createStatistics(u32bit gpuId);
