...
public:
    ...
    BankQueueScheduler( u32bit gpuId, u32bit schedulerId, const char* name,
                        const char* prefix,
                        Box* parent,
...
private:
    ...
    GPUStatistics::Statistic& globalClosePageActivationsCount; // Counts how many times the close page algorithm is activated
