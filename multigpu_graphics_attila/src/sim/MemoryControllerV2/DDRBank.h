...
public:
     ...
     */
    DDRBurst* read(u32bit column, u32bit burstSize, bool debug = false, u32bit debugThread = 0) const;
    ...
    void setGpuID(u32bit id) { gpuID = id; }   
    void setModuleID(u32bit id) { moduleID = id; }   
    void setBankID(u32bit id) { bankID = id; }   
};
