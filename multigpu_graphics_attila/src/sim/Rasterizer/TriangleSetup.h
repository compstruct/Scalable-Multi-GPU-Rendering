...
private:
    ...
    GPUStatistics::Statistic *setupTrianglesSend;

    GPUStatistics::Statistic *globalInputs;   /**<  Number of input triangles.  */
    GPUStatistics::Statistic *globalOutputs;  /**<  Number of outputs triangles.  */
    GPUStatistics::Statistic *globalRequests; /**<  Triangle requests from Fragment Generation.  */
    GPUStatistics::Statistic *globalCulled;   /**<  Number of culled triangles.  */
    GPUStatistics::Statistic *globalFront;    /**<  Number of front facing triangles.  */
    GPUStatistics::Statistic *globalBack;     /**<  Number of back facing triangles.  */
    GPUStatistics::Statistic *globalSetupTrianglesSend;
    ...
    GPUStatistics::Statistic *globalCount_less_1;         /**<  Non-culled triangles of less than 1 pixel size.  */ 
    GPUStatistics::Statistic *globalCount_1_to_4;         /**<  Non-culled triangles between 1 and less than 4 pixels size.  */
    GPUStatistics::Statistic *globalCount_4_to_16;        /**<  Non-culled triangles between 4 and less than 16 pixels size.  */
    GPUStatistics::Statistic *globalCount_16_to_100;      /**<  Non-culled triangles between 16 and less than 100 pixels size.  */
    GPUStatistics::Statistic *globalCount_100_to_1000;    /**<  Non-culled triangles between 100 and less than 1000  pixels size.  */
    GPUStatistics::Statistic *globalCount_1000_to_screen; /**<  Non-culled triangles between 1000 and less than screen pixels size.  */
    GPUStatistics::Statistic *globalCount_greater_screen; /**<  Non-culled triangles greater than screen pixels size.  */
    GPUStatistics::Statistic *globalCount_overlap_1x1;    /**<  Non-culled triangles overlapping just one screen pixel.  */
    GPUStatistics::Statistic *globalCount_overlap_2x2;    /**<  Non-culled triangles overlapping just 2x2 screen pixels.  */ 
...
public:
    ...
    TriangleSetup(u32bit gpuId, char* gpuPrefix, u32bit numGPUs, u32bit multiGPUExecMode, u32bit execRound,
	RasterizerEmulator &rastEmu, u32bit trianglesCycle, u32bit setupFIFOSize,
