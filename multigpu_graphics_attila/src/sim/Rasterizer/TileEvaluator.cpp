...
TileEvaluator::TileEvaluator(u32bit gpuId, RasterizerEmulator &emu, u32bit tilesPerCycle,
    ...
    evaluationLatency(evalLatency), prefix(tePrefix), Box(gpuId, name, parent)
