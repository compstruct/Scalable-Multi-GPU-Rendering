...
private:
    ...
    kdTreeNodeExtentsInSortLast_t *kdTreeNodeExtents;
    RasterizerEmulator &rastEmu;    /**<  Reference to the Rasterizer Emulator used to generate fragments.  */
    bool d3d9DepthRange;
    s32bit nodeExtentMin[3];
    s32bit nodeExtentMax[3];
    bool nodeExtentCulling;
    bool anyRtBlend;
    ...
    u32bit displayTileWidth;         /**<  Display tile width in stamps.  */
    u32bit displayTileHeight;        /**<  Display tile height in stamps.  */
    ...
    GPUStatistics::Statistic *outDisplay;     /**<  Fragments outside display tile.  */
    ...
    GPUStatistics::Statistic *hzSentStamps;
    GPUStatistics::Statistic *inputsRead;
    GPUStatistics::Statistic *inputsSend;
    GPUStatistics::Statistic *inputsCulled;

    GPUStatistics::Statistic *globalInputs;         /**<  Input fragments.  */
    GPUStatistics::Statistic *globalOutputs;        /**<  Output fragments.  */
    GPUStatistics::Statistic *globalOutTriangle;    /**<  Fragments outside triangle.  */
    GPUStatistics::Statistic *globalOutViewport;    /**<  Fragments outside viewport.  */
    GPUStatistics::Statistic *globalOutDisplay;     /**<  Fragments outside display tile.  */
    GPUStatistics::Statistic *globalCulled;         /**<  Culled fragments.  */
    GPUStatistics::Statistic *globalCullOutside;    /**<  Fragments outside triangle or viewport culled.  */
    GPUStatistics::Statistic *globalCullHZ;         /**<  Fragments culled by HZ test.  */
    GPUStatistics::Statistic *globalMisses;         /**<  Misses to HZ Cache.  */
    GPUStatistics::Statistic *globalHits;           /**<  Hits to HZ Cache.  */
    GPUStatistics::Statistic *globalReads;          /**<  Read operations to the HZ Buffer.  */
    GPUStatistics::Statistic *globalWrites;         /**<  Write operations to the HZ Buffer.  */
    GPUStatistics::Statistic *globalHZSentStamps;
    GPUStatistics::Statistic *globalInputsRead;
    GPUStatistics::Statistic *globalInputsSend;
    GPUStatistics::Statistic *globalInputsCulled;
...
public:
    ...
    HierarchicalZ(u32bit gpuId, u32bit numGPUs_, u32bit multiGPUExecMode_, char* gpuPrefix,
        RasterizerEmulator &rastEmu, u32bit stampCycle,
	u32bit displayW, u32bit displayH, u32bit overW, u32bit overH, u32bit scanW, u32bit scanH,
    ...
    void setPtrOfKDTreeNodeExtentsInSortLast(kdTreeNodeExtentsInSortLast_t *ptr);
