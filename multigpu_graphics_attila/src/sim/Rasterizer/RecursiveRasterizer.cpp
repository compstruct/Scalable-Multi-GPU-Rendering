...
RecursiveRasterizer::RecursiveRasterizer(u32bit gpuId,char *gpuPrefix, RasterizerEmulator &rsEmu,
...
interpolators(numInterpolators), Box(gpuId, name, parent)

{
    ...
    recDescComm = newOutputSignal("RecursiveDescentCommand", 1, 1, gpuPrefix);

    /*  Create state signal from Recursive Descent.  */
    recDescState = newInputSignal("RecursiveDescentState", 1, 1, gpuPrefix);
    ...
    triangleSetup = new TriangleSetup(gpuId, gpuPrefix, rastEmu, tsFIFOSize,
        "TriangleSetup", this);

    /*  Create Recursive Descent box.  */
    recDescent = new RecursiveDescent(gpuId, gpuPrefix, rastEmu, recDescTrFIFOSize,
    ...
    for(i = 0; i < numTileEvaluators; i++)
    {
        ...
        tileEvaluator[i] = new TileEvaluator(gpuId, rastEmu, tilesCycle,
    ...
    interpolator = new Interpolator(gpuId, gpuPrefix, rastEmu, interpolators,
