...
private:
    ...
    FragmentInputType type;
    u32bit srcGPUId;
    u32bit destGPUId;
    u32bit size;

    bool dummyGenAfterZTest;
...
public:
    ...
    bool getDummyGenAfterZTest() { return dummyGenAfterZTest; }
    void setDummyGenAfterZTest(bool dummyGenAfterZTest_) { dummyGenAfterZTest = dummyGenAfterZTest_; }
    ...
    void setType(FragmentInputType type_) { type = type_; }
    FragmentInputType getType() { return type; }
    void setSrcGPUId(u32bit srcGPUId_) { srcGPUId = srcGPUId_; }
    u32bit getSrcGPUId() { return srcGPUId; }
    void setDestGPUId(u32bit destGPUId_) { destGPUId = destGPUId_; }
    u32bit getDestGPUId() { return destGPUId; }
    void incSize(u32bit size_) { size += size_; }
    u32bit getSize() const { return size; }
