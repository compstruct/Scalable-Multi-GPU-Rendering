...
private:
    ...
    GPUStatistics::Statistic *globalInputs;            /**<  Input triangles.  */
    GPUStatistics::Statistic *globalRequests;          /**<  Triangle requests.  */
    GPUStatistics::Statistic *globalOutputs;           /**<  Output fragments.  */
    GPUStatistics::Statistic *globalUtilizationCycles; /**<  Cycle when rasterizer is doing real work (ie: waiting HZ is not accounted as utilizationCycles) */
    ...
    GPUStatistics::Statistic *triangleBatchSize;

    GPUStatistics::Statistic *globalStamps0frag;           /**<  Empty stamps.                              */
    GPUStatistics::Statistic *globalStamps1frag;           /**<  Output stamps with 1 covered fragment.     */
    GPUStatistics::Statistic *globalStamps2frag;           /**<  Output stamps with 2 covered fragments.    */
    GPUStatistics::Statistic *globalStamps3frag;           /**<  Output stamps with 3 covered fragments.    */
    GPUStatistics::Statistic *globalStamps4frag;           /**<  Full covered stamps.                       */
    GPUStatistics::Statistic *globalNumRastStamps;
    GPUStatistics::Statistic *globalTriangleBatchSize;
...
public:
    ...
    TriangleTraversal(u32bit gpuId, char* gpuPrefix, RasterizerEmulator &rasEmu, u32bit trianglesCycle, u32bit setupLat,
