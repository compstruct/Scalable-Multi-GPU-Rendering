...
TriangleSetup::TriangleSetup(u32bit gpuId, char *gpuPrefix, u32bit numGPUs_, u32bit multiGPUExecMode_, u32bit execRound_,
    RasterizerEmulator &rasEmu, u32bit cycleTriangles, u32bit tsFIFOSize,
    ...
    triangleShaderQSz(triShQSz), rastEmu(rasEmu), frameDupInSortLast(false), Box(gpuId, name, parent)

{
    ...
    /*  Create statistics.  */
    inputs = &getSM(gpuId).getNumericStatistic("InputTriangles", u32bit(0), "TriangleSetup", "TS");
    outputs = &getSM(gpuId).getNumericStatistic("OutputTriangles", u32bit(0), "TriangleSetup", "TS");
    requests = &getSM(gpuId).getNumericStatistic("RequestedTriangles", u32bit(0), "TriangleSetup", "TS");
    culled = &getSM(gpuId).getNumericStatistic("CulledTriangles", u32bit(0), "TriangleSetup", "TS");
    front = &getSM(gpuId).getNumericStatistic("FrontFacingTriangles", u32bit(0), "TriangleSetup", "TS");
    back = &getSM(gpuId).getNumericStatistic("BackFacingTriangles", u32bit(0), "TriangleSetup", "TS");
    setupTrianglesSend= &getSM(gpuId).getNumericStatistic("NumSetupTrianglesSend", u32bit(0), "TriangleSetup", "TS");

    globalInputs = &getSM().getNumericStatistic("InputTriangles", u32bit(0), "TriangleSetup", "TS");
    globalOutputs = &getSM().getNumericStatistic("OutputTriangles", u32bit(0), "TriangleSetup", "TS");
    globalRequests = &getSM().getNumericStatistic("RequestedTriangles", u32bit(0), "TriangleSetup", "TS");
    globalCulled = &getSM().getNumericStatistic("CulledTriangles", u32bit(0), "TriangleSetup", "TS");
    globalFront = &getSM().getNumericStatistic("FrontFacingTriangles", u32bit(0), "TriangleSetup", "TS");
    globalBack = &getSM().getNumericStatistic("BackFacingTriangles", u32bit(0), "TriangleSetup", "TS");
    globalSetupTrianglesSend= &getSM().getNumericStatistic("NumSetupTrianglesSend", u32bit(0), "TriangleSetup", "TS");

    /*  Create triangle size related statistics.  */
    count_less_1 = &getSM(gpuId).getNumericStatistic("TrianglesLess_1", u32bit(0), "TriangleSetup", "TS");
    count_1_to_4 = &getSM(gpuId).getNumericStatistic("Triangles1_to_4", u32bit(0), "TriangleSetup", "TS");
    count_4_to_16 = &getSM(gpuId).getNumericStatistic("Triangles4_to_16", u32bit(0), "TriangleSetup", "TS");
    count_16_to_100 = &getSM(gpuId).getNumericStatistic("Triangles16_to_100", u32bit(0), "TriangleSetup", "TS");
    count_100_to_1000 = &getSM(gpuId).getNumericStatistic("Triangles100_to_1000", u32bit(0), "TriangleSetup", "TS");
    count_1000_to_screen = &getSM(gpuId).getNumericStatistic("Triangles1000_to_Screen", u32bit(0), "TriangleSetup", "TS");
    count_greater_screen = &getSM(gpuId).getNumericStatistic("TrianglesGreaterScreen", u32bit(0), "TriangleSetup", "TS");
    count_overlap_1x1 = &getSM(gpuId).getNumericStatistic("TrianglesOverlap_1x1", u32bit(0), "TriangleSetup", "TS");
    count_overlap_2x2 = &getSM(gpuId).getNumericStatistic("TrianglesOverlap_2x2", u32bit(0), "TriangleSetup", "TS");

    globalCount_less_1 = &getSM().getNumericStatistic("TrianglesLess_1", u32bit(0), "TriangleSetup", "TS");
    globalCount_1_to_4 = &getSM().getNumericStatistic("Triangles1_to_4", u32bit(0), "TriangleSetup", "TS");
    globalCount_4_to_16 = &getSM().getNumericStatistic("Triangles4_to_16", u32bit(0), "TriangleSetup", "TS");
    globalCount_16_to_100 = &getSM().getNumericStatistic("Triangles16_to_100", u32bit(0), "TriangleSetup", "TS");
    globalCount_100_to_1000 = &getSM().getNumericStatistic("Triangles100_to_1000", u32bit(0), "TriangleSetup", "TS");
    globalCount_1000_to_screen = &getSM().getNumericStatistic("Triangles1000_to_Screen", u32bit(0), "TriangleSetup", "TS");
    globalCount_greater_screen = &getSM().getNumericStatistic("TrianglesGreaterScreen", u32bit(0), "TriangleSetup", "TS");
    globalCount_overlap_1x1 = &getSM().getNumericStatistic("TrianglesOverlap_1x1", u32bit(0), "TriangleSetup", "TS");
    globalCount_overlap_2x2 = &getSM().getNumericStatistic("TrianglesOverlap_2x2", u32bit(0), "TriangleSetup", "TS");

    /*  Create command signal from the main Rasterizer box.  */
    setupCommand = newInputSignal("TriangleSetupCommand", 1, 1, gpuPrefix);

    /*  Create state signal to the main Rasterizer state.  */
    rastSetupState = newOutputSignal("TriangleSetupRasterizerState", 1, 1, gpuPrefix);
	...
	if (numGPUs > 1 && multiGPUExecMode == GPUPD && execRound == 2) {
            ...
            inputTriangle = newInputSignal("RasterizerNewTriangleFromPAS", trianglesCycle, paLatency, gpuPrefix);

            /*  Create request signal to the Clipper.  */
            triangleRequest = newOutputSignal("PASRasterizerRequest", 1, 1, gpuPrefix);
	} else {
            /*  Create new triangle signal from Primitive Assembly/Clipper.  */
            inputTriangle = newInputSignal("RasterizerNewTriangle", trianglesCycle, paLatency, gpuPrefix);

            /*  Create request signal to the Clipper.  */
            triangleRequest = newOutputSignal("ClipperRasterizerRequest", 1, 1, gpuPrefix);
	}
    }
    else
    {
        /*  Create new triangle signal from Triangle Bound Unit.  */
        inputTriangle = newInputSignal("TriangleBoundNewTriangle", trianglesCycle, tbLatency, gpuPrefix);

        /*  Create request signal to the TriangleBound Unit.  */
        triangleRequest = newOutputSignal("TriangleBoundRequest", 1, 1, gpuPrefix);
    }

    /*  Create output signal to the Triangle Traversal/Fragment Generator.  */
    setupOutput = newOutputSignal("TriangleSetupOutput", trianglesCycle, fgLatency, gpuPrefix);

    /*  Create request signal from the Triangle Traversal/Fragment Generator.  */
    setupRequest = newInputSignal("TriangleSetupRequest", 1, 1, gpuPrefix);
    ...
    if (shaderSetup)
    {
        ...
        setupShaderInput = newOutputSignal("TriangleShaderInput", numSetupUnits, setupLatency, gpuPrefix);

        /*  Create triangle output signal from the unified shaders (FragmentFIFO).  */
        setupShaderOutput = newInputSignal("TriangleShaderOutput", numSetupUnits, setupLatency, gpuPrefix);

        /*  Create state signal from the unified shaders (FragmentFIFO).  */
        setupShaderState = newInputSignal("TriangleShaderState", 1, 1, gpuPrefix);
    }
    else
    {
        /*  Create setup start signal to the Triangle Setup box.  */
        setupStart = newOutputSignal("TriangleSetup", numSetupUnits, setupLatency, gpuPrefix);

        /*  Create setup ed signal from the Triangle Setup box.  */
        setupEnd = newInputSignal("TriangleSetup", numSetupUnits, setupLatency, gpuPrefix);
    }
...
void TriangleSetup::clock(u64bit cycle)
{
    ...
    QuadFloat *vertAttr2;
    QuadFloat *vertAttr3;
    u32bit vIndex1, vIndex2, vIndex3;
    u32bit triangleID;
    u32bit triRequest;
    ...
    switch(state)
    {
        ...
        case RAST_DRAWING:
		    ...
		    if ((numGPUs == 1 && multiGPUExecMode == FRAME_DUP && newBatch) || (numGPUs > 1 && multiGPUExecMode == SORT_LAST && newBatch &&
		        GPUDriver::getGPUDriver()->getGPUSchedInfo()->isScheduledToThisGPU(frameCounter, batchCounter, gpuId))) {
		        GPUDriver::getGPUDriver()->getGPUSchedInfo()->recordFragProcessStartCycle(frameCounter, batchCounter, gpuId, cycle);
			newBatch = false;
		    }
		    ...
		    shInput->setBatchCounter(batchCounter);
		    shInput->setFrameCounter(frameCounter);
			    ...
			    triangleShaderQueue[nextShaderTriangle].tsInput->getIndexes(vIndex1, vIndex2, vIndex3);
            ...
            else
            {
                ...
                while (setupEnd->read(cycle, (DynamicObject *&) tsInput))
                {
                    ...
                    if (!tsInput->isLast())
                    {
                        ...
                        vertAttr2 = tsInput->getVertexAttributes(1);
                        vertAttr3 = tsInput->getVertexAttributes(2);
			tsInput->getIndexes(vIndex1, vIndex2, vIndex3);
                        ...
                        {
                            /*  Ask the rasterizer emulator to setup the triangle.  */
                            triangleID = rastEmu.setup(vertAttr1, vertAttr2, vertAttr3, vIndex1, vIndex2, vIndex3);
                        }
                    }
                    else
                    {
...
bool TriangleSetup::cullFaceTest(u32bit triangleID, u32bit setupID, f64bit &tArea)
{
    ...
    if ((!dropTriangle) && (multiGPUExecMode != SORT_LAST || frameDupInSortLast)) {
        dropTriangle = rastEmu.multiGPUDisplayTest(hRes, vRes, setupID, GPUPD);
        ...
        if (dropTriangle) {
            ...
            GPU_DEBUG_BOX(
                printf("TriangleSetup => Cull DISPLAY_TILE_TEST.  Culling triangle ID %d.\n", triangleID);
            )
        }
    }
    ...
    if (!dropTriangle)
    {
        ...
        if (area < 1.0) {
           count_less_1->inc();
           globalCount_less_1->inc();
        } else if (area < 4.0) {
           count_1_to_4->inc();
           globalCount_1_to_4->inc();
        } else if (area < 16.0) {
           count_4_to_16->inc();
           globalCount_4_to_16->inc();
        } else if (area < 100.0) {
           count_16_to_100->inc();
           globalCount_16_to_100->inc();
        } else if (area < 1000.0) {
           count_100_to_1000->inc();
           globalCount_100_to_1000->inc();
        } else if (area < screen_size) {
           count_1000_to_screen->inc();
           globalCount_1000_to_screen->inc();
        } else if (area >= screen_size) {
           count_greater_screen->inc();
           globalCount_greater_screen->inc();
	}
        ...
        if ((overlapsX == 1) && (overlapsY == 1)) {
           ...
           globalCount_overlap_1x1->inc();
        }

        if ((overlapsX <= 2) && (overlapsY <= 2)) {
           count_overlap_2x2->inc();
           globalCount_overlap_2x2->inc();
	}
    }
...
cycle, setupTriangles, setupReserves, triangleCounter, trianglesRequested, trianglesCycle, i);
    ...
    if (numTriangles > 0) {
	setupTrianglesSend->incavg(numTriangles);
	globalSetupTrianglesSend->incavg(numTriangles);
    }
}
