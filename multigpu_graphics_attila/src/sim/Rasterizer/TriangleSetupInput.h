...
private:
    ...
    u32bit indexes[3];          /**<  Triangle vertex indexes.  */
    ...
    bool preBound;
    std::bitset<8*sizeof(unsigned int)> mappedGPUIds; // which GPUs should this triangles be mapped to
...
public:
    ...
    TriangleSetupInput(u32bit id, QuadFloat *attrib1, QuadFloat *attrib2, 
        QuadFloat *attrib3, u32bit index1, u32bit index2, u32bit index3, bool last);
    ...
    void getIndexes(u32bit &index1, u32bit &index2, u32bit &index3) const;
    void setMappedGPUIds(u32bit gpuId);
    u32bit getMappedGPUIds() const;
