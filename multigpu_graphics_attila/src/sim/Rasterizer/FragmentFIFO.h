...
private:
    ...
    u32bit syncQueueSz;         /**<  Inter-GPU synchronization queue size.  */
    u32bit interGPUSyncQueueSz;
    ...
    FragmentInput ****syncQueueIn;
    u32bit *nextSyncIn;
    u32bit *nextFreeSyncIn;
    u32bit *syncInStamps;
    static u32bit **freeSyncIn;
    u32bit allSyncInStamps;

    std::vector<std::queue<FragmentInput*> > idealSyncQueueIn;

    FragmentInput ****syncQueueOutZST;
    u32bit *nextSyncOutZST;
    u32bit *nextFreeSyncOutZST;
    u32bit *syncOutStampsZST;
    u32bit *freeSyncOutZST;
    u32bit allSyncOutStampsZST;

    FragmentInput ****syncQueueOutCW;
    u32bit *nextSyncOutCW;
    u32bit *nextFreeSyncOutCW;
    u32bit *syncOutStampsCW;
    u32bit *freeSyncOutCW;
    u32bit allSyncOutStampsCW;

    static u32bit **syncedStampUnits;
    u32bit notLastSyncSent;
    u32bit notLastSyncReceive;

    bool compSchedEnabled;
    static std::vector<std::vector<bool> > allStampsReceivedForSync;
    ...
    bool compMode;
    f32bit dummyFragsGenPossibility;
    ...
    GPUStatistics::Statistic *interGPUSyncCannotSend;
    GPUStatistics::Statistic *interGPUSyncTransCycleStall;
    GPUStatistics::Statistic *waitIntStalls;
    GPUStatistics::Statistic *numStampsToInt;
    GPUStatistics::Statistic *numZSTUnitsSendRastStampsTo;
    GPUStatistics::Statistic *numRastStampsToZSTUnit;
    GPUStatistics::Statistic *numZSTUnitsSendShadedStampsTo;
    GPUStatistics::Statistic *numShadedStampsToZSTUnit;
    GPUStatistics::Statistic *numZSTUnitsReceiveStampsFrom;
    GPUStatistics::Statistic *numStampsFromZSTUnit;
    GPUStatistics::Statistic *numRastStamps;
    GPUStatistics::Statistic *numFragsPassZTest;
    GPUStatistics::Statistic *numFragsPassZTestInCompMode;
    GPUStatistics::Statistic *numFragsNotPassZTest;
    GPUStatistics::Statistic *numFragsNotPassZTestInCompMode;
    GPUStatistics::Statistic *numFragsPassZTestEarlyZ;
    GPUStatistics::Statistic *numFragsPassZTestEarlyZInCompMode;
    GPUStatistics::Statistic *numFragsNotPassZTestEarlyZ;
    GPUStatistics::Statistic *numFragsNotPassZTestEarlyZInCompMode;
    GPUStatistics::Statistic *numDummyFrags;

    GPUStatistics::Statistic *globalInputs;       /**<  Input fragments from HZ.  */
    GPUStatistics::Statistic *globalInterpolated; /**<  Interpolated fragments.  */
    GPUStatistics::Statistic *globalShadedFrag;   /**<  Shaded fragments.  */
    GPUStatistics::Statistic *globalOutputs;      /**<  Output fragments to Z Stencil.  */
    GPUStatistics::Statistic *globalInVerts;      /**<  Input vertices.  */
    GPUStatistics::Statistic *globalShVerts;      /**<  Shaded vertices.  */
    GPUStatistics::Statistic *globalOutVerts;     /**<  Output vertices.  */
    GPUStatistics::Statistic *globalInTriangles;  /**<  Input triangles.  */
    GPUStatistics::Statistic *globalOutTriangles; /**<  Output triangles.  */
    GPUStatistics::Statistic *globalShTriangles;  /**<  Shaded triangles.  */
    GPUStatistics::Statistic *globalRastGLevel;   /**<  Occupation of the rasterized stamp queues.  */
    GPUStatistics::Statistic *globalTestGLevel;   /**<  Occupation of the early z tested stamp queues.  */
    GPUStatistics::Statistic *globalIntGLevel;    /**<  Occupation of the interpolated stamp queues.  */
    GPUStatistics::Statistic *globalShadedGLevel; /**<  Occupation of the shader stamp queues.  */
    GPUStatistics::Statistic *globalVertInLevel;  /**<  Occupation of the vertex input queue.  */
    GPUStatistics::Statistic *globalVertOutLevel; /**<  Occupation of the vertex output queue.  */
    GPUStatistics::Statistic *globalTrInLevel;    /**<  Occupation of the triangle input queue.  */
    GPUStatistics::Statistic *globalTrOutLevel;   /**<  Occupation of the triangle output queue.  */
    GPUStatistics::Statistic *globalInterGPUSyncTrafficLoad;
    GPUStatistics::Statistic *globalInterGPUSyncCannotSend;
    GPUStatistics::Statistic *globalInterGPUSyncTransCycleStall;
    GPUStatistics::Statistic *globalWaitIntStalls;
    GPUStatistics::Statistic *globalNumStampsToInt;
    GPUStatistics::Statistic *globalNumZSTUnitsSendRastStampsTo;
    GPUStatistics::Statistic *globalNumRastStampsToZSTUnit;
    GPUStatistics::Statistic *globalNumZSTUnitsSendShadedStampsTo;
    GPUStatistics::Statistic *globalNumShadedStampsToZSTUnit;
    GPUStatistics::Statistic *globalNumZSTUnitsReceiveStampsFrom;
    GPUStatistics::Statistic *globalNumStampsFromZSTUnit;
    GPUStatistics::Statistic *globalNumRastStamps;
    GPUStatistics::Statistic *globalNumFragsPassZTest;
    GPUStatistics::Statistic *globalNumFragsPassZTestInCompMode;
    GPUStatistics::Statistic *globalNumFragsNotPassZTest;
    GPUStatistics::Statistic *globalNumFragsNotPassZTestInCompMode;
    GPUStatistics::Statistic *globalNumFragsPassZTestEarlyZ;
    GPUStatistics::Statistic *globalNumFragsPassZTestEarlyZInCompMode;
    GPUStatistics::Statistic *globalNumFragsNotPassZTestEarlyZ;
    GPUStatistics::Statistic *globalNumFragsNotPassZTestEarlyZInCompMode;
    ...
    void endGenerationOfZSTSyncFragments(u64bit cycle);
    void sendZSTSyncFragmentsColorWrite(u64bit cycle);
    void endGenerationOfCWSyncFragments(u64bit cycle);
    void sendSyncFragmentsToOtherGPU(u64bit cycle);
    void receiveSyncFragments(u64bit cycle);
    void processInputSyncFragments(u64bit cycle);
...
public:
    ...
    *  Creates and initializes a Fragment FIFO box.
    ...
    FragmentFIFO(u32bit gpuId, u32bit numGPUs, u32bit multiGPUExecMode, bool compSchedEnabled,
	bool idealComp, u32bit interGPUBusWidth, u32bit interGPUBusLat,
	char *gpuPrefix, u32bit hzStampsCycle, u32bit stampsCycle, bool unified, bool shadedSetup,
        ...
        u32bit rastQSz, u32bit testQSz, u32bit intQSz, u32bit shaderQSz, u32bit syncQSz, u32bit interGPUSyncQSz,
	f32bit dummyFragsGenPossibility,
    ...
    void setCompMode(bool compMode_) { compMode = compMode_; }
};
