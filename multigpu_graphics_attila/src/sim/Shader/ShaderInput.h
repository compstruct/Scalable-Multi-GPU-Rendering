...
private:
    ...
    QuadFloat *attributes3D;   /**<  Protect 3D attributes after geometry processing if necessary. */
...
public:
    ...
    /**
     *
     *  Gets the shader input attributes in 3D space.
     *
     *  @return A pointer to the shader input attribute array of 3D space.
     *
     */
    ...
    /**
     *
     *  Keep the shader input attributes in 3D space.
     *
     */

    void keep3DAttributes();
