...
private:
    ...
    GPUStatistics::Statistic *globalTxRequests;   /**<  Number of texture requests from Shader Decode Execute.  */
    GPUStatistics::Statistic *globalResults;      /**<  Number of texture results from Shader Decode Execute.  */
    GPUStatistics::Statistic *globalFetchOK;      /**<  Succesful fetch operations.  */
    GPUStatistics::Statistic *globalFetchSkip;    /**<  Skip already fetched texel.  */
    GPUStatistics::Statistic *globalFetchFail;    /**<  Unsuccesful fetch operations.  */
    GPUStatistics::Statistic *globalFetchStallFetch;      /**<  Number of cycles the fetch stage stalls because there are no fetches waiting in the queue.  */
    GPUStatistics::Statistic *globalFetchStallAddress;    /**<  Number of cycles the fetch stage stalls because the address for the next fetch has not been calculated.  */
    GPUStatistics::Statistic *globalFetchStallWaitRead;   /**<  Number of cycles the fetch stage stalls because there are no free entries in the wait read window.  */
    GPUStatistics::Statistic *globalFetchStallReadyRead;  /**<  Number of cycles the fetch stage stalls because the ready read queue has no free entries.  */
    ...
    GPUStatistics::Statistic *globalReadyReadLevel;   /**<  Occupation of the ready read queue.  */
    GPUStatistics::Statistic *globalWaitReadLevel;    /**<  Occupation of the wait read window.  */
    GPUStatistics::Statistic *globalResultLevel;      /**<  Occupation of the texture result queue.  */
    GPUStatistics::Statistic *globalAccessLevel;      /**<  Occupation of the texture access queue.  */
    GPUStatistics::Statistic *globalRequestLevel;     /**<  Occupation of the texture request queue.  */
    GPUStatistics::Statistic *globalAddrALUBusy;      /**<  Address ALU busy cycles.  */
    GPUStatistics::Statistic *globalFilterALUBusy;    /**<  Filter ALU busy cycles.  */
    GPUStatistics::Statistic *globalTextResLat;       /**<  Texture result latency in cycles.  */
    GPUStatistics::Statistic *globalBilinearSamples;  /**<  Number of bilinear samples per texture access.  */
    GPUStatistics::Statistic *globalAnisoRatio;       /**<  Anisotropy ratio per texture access.  */
    GPUStatistics::Statistic *globalAddrCalcFinished; /**<  Number of texture access that have finished address calculation.  */
    GPUStatistics::Statistic *globalAnisoRatioHisto[MAX_ANISOTROPY + 1];  /**<  Histogram of computed anisotropy ratio.  */
    GPUStatistics::Statistic *globalBilinearsHisto[MAX_ANISOTROPY * 2];   /**<  Histogram of bilinear sampler required per request.  */
    GPUStatistics::Statistic *globalMagnifiedPixels;  /**<  Number of magnified pixels.  */
    GPUStatistics::Statistic *globalMipsSampled[2];   /**<  Number of mipmaps sampled (per request).  */
    GPUStatistics::Statistic *globalPointSampled;     /**<  Number of point sampled pixels.  */
...
public:
    ...
    TextureUnit(u32bit gpuId, u32bit shaderID, u32bit unitID, u32bit cacheID, u32bit numTextUnits,
	TextureEmulator &txEmu, u32bit frStamp, u32bit reqCycle, u32bit reqQueueSz, u32bit accQueueSz,
