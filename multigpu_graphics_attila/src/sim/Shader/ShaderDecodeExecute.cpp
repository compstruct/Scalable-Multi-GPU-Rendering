...
ShaderDecodeExecute::ShaderDecodeExecute(u32bit gpuId, ShaderEmulator &shEmu, bool unified, u32bit threads,
    ...
    /*  Initializations  */
    Box(gpuId, name, parent), shEmul(shEmu), unifiedModel(unified), numThreads(threads), threadsCycle(threadsPerCycle),
