...
private:
    ...
    u32bit rtAddressForComp[MAX_RENDER_TARGETS];
    ...
    BlendFunction srcRGBForComp[MAX_RENDER_TARGETS];       /**<  Source RGB weight funtion for comp.  */
    BlendFunction dstRGBForComp[MAX_RENDER_TARGETS];       /**<  Destination RGB weight function for comp.  */
    BlendFunction srcAlphaForComp[MAX_RENDER_TARGETS];     /**<  Source alpha weight function for comp.  */
    BlendFunction dstAlphaForComp[MAX_RENDER_TARGETS];     /**<  Destination alpha weight function for comp.  */
    ...
    u8bit clearColorDataForComp[MAX_BYTES_PER_COLOR];
    ...
    GPUStatistics::Statistic *globalBlended;      /**<  Blended fragments.  */
    GPUStatistics::Statistic *globalLogoped;      /**<  Logical operation fragments.  */
...
public:
    ...
    ColorWriteV2(u32bit gpuId, u32bit numGPUs, u32bit multiGPUExecMode, u32bit stampId, u32bit stampsCycle,
	...
	u32bit colorInQSz, u32bit colorFetchQSz, u32bit colorReadQSz, u32bit colorOpQSz,
        u32bit colorWriteQSz, u32bit blendRate, u32bit blendLatency, u32bit blockStateLatency,
        u32bit fragMapMode, FragmentOpEmulator &frOp, u32bit syncCommQueueSize,
	u32bit colorSyncInQSz, u32bit colorSyncFetchQSz, u32bit colorSyncReadQSz,
