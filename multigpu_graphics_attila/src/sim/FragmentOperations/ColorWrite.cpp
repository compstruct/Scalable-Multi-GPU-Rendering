...
ColorWrite::ColorWrite(u32bit gpuId, u32bit numStamps, u32bit overWidth, u32bit overHeight,
    ...
    blockStateLatency(blockLatency), fragmentMapMode(fragMapMode), frEmu(fragEmu), Box(gpuId, name, parent)
...
void ColorWrite::processStamp()
{
    ...
    if (!lastFragment)
    {
        ...
        else
        {
            ...
            globalCulled->inc(STAMP_FRAGMENTS);
        }
    }
    else
    {
