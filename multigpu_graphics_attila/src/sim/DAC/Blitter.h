...
public:
    ...
    virtual GPUStatistics::StatisticsManager& getSM(u32bit gpuId) = 0;
...
public:
    ...
    u32bit              gpuId;              /**<  The gpuId from which you should get this colorBufferBlock. */
...
public:
    ...
    std::vector<ColorBufferBlock*> colorBufferBlocks;      /**<  The related color buffer blocks in different GPUs.  */
...
private:
    ...
    GPUStatistics::Statistic &globalReadBlocks;                       /**<  Number of color buffer blocks read from memory.  */
    GPUStatistics::Statistic &globalWrittenBlocks;                    /**<  Number of texture blocks written to memory.  */
    
    GPUStatistics::Statistic &globalClearColorBlocks;                 /**<  Number of clear color blocks.  */
    GPUStatistics::Statistic &globalUncompressedBlocks;               /**<  Number of uncompressed color blocks.  */
    GPUStatistics::Statistic &globalCompressedBestBlocks;             /**<  Number of best compressed color blocks.  */
    GPUStatistics::Statistic &globalCompressedNormalBlocks;           /**<  Number of normal compressed color blocks.  */
    GPUStatistics::Statistic &globalCompressedWorstBlocks;             /**<  Number of worst compressed color blocks.  */

    GPUStatistics::Statistic &globalRequestPendingQueueFull;           /**<  Cycles the request pending queue is full.  */
    GPUStatistics::Statistic &globalReceiveDataPendingWakeUpQueueFull; /**<  Cycles the receive pending wakeup queue is full.  */
    GPUStatistics::Statistic &globalDecompressionPendingQueueFull;     /**<  Cycles the decompression pending queue is full.  */
    GPUStatistics::Statistic &globalSwizzlingPendingQueueFull;         /**<  Cycles the swizzling pending queue is full.  */
    GPUStatistics::Statistic &globalWritePendingQueueFull;             /**<  Cycles the write pending queue is full.  */
...
public:
    ...
    /**
      ...
      */
    Blitter(u32bit gpuId, u32bit numGPUs, u32bit multiGPUExecMode, BlitterTransactionInterface& transactionInterface, 
    ...
    u32bit getBlitDestAddress() { return blitDestinationAddress; }
    u32bit getBackBufferAddress() { return backBufferAddress; }
...
private:
    ...
    /**
      ...
      *  If out of display tile, return false, otherwise return true
      *
      */
    bool processNewTextureBlock(u64bit cycle, u32bit xBlock, u32bit yBlock, TextureBlock* textureBlock);
    ...
    /**
      ...
      *  sent transactions.
      */
    bool requestColorBlock(u64bit cycle, ColorBufferBlock *bInfo, u32bit blockRequestSize, set<u32bit>& generatedTickets, u32bit textureBlockAddr);
