...
#undef CHECK_FILE
    ...
    char *filters[] = 
    {
        strdup(std::string("*MESA").c_str()),
        strdup(std::string("*SUN").c_str()),
        strdup(std::string("*IBM").c_str()),
        strdup(std::string("ChoosePixelFormat").c_str()),
        strdup(std::string("DescribePixelFormat").c_str()),
        strdup(std::string("GetPixelFormat").c_str()),
        strdup(std::string("SetPixelFormat").c_str()),
        strdup(std::string("SwapBuffers").c_str())
    };
