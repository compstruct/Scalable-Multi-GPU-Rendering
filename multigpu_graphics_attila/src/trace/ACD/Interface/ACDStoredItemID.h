...
enum ACD_STORED_ITEM_ID
{
    ...
    ACD_DEV_STREAM_START_OF_FAN         =   ACD_DEVICE_FIRST_ID + 14,
    ACD_DEV_FRAME_DUP_IN_SORT_LAST      =   ACD_DEVICE_FIRST_ID + 15,
    ACD_DEV_VERTEX_ATTRIBUTE_MAP        =   ACD_DEVICE_FIRST_ID + 16, 
    ...
    ACD_DEV_PROPERTIES_COUNT = 17 + gpu3d::MAX_VERTEX_ATTRIBUTES + gpu3d::MAX_VERTEX_ATTRIBUTES + gpu3d::MAX_FRAGMENT_ATTRIBUTES,
