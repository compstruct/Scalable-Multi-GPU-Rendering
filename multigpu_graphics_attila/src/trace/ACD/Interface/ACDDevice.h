...
public:
    ...
    virtual u32bit getNumGPUs() const = 0;
    virtual u32bit getMultiGPUExecMode() const = 0;
    virtual u32bit getExecRound() const = 0;
    ...
    // HACK for multi-GPU architecture
    //virtual void draw(acd_uint start, acd_uint count, std::vector<acd_uint> starts, std::vector<acd_uint> counts, acd_uint instances = 1) = 0;
