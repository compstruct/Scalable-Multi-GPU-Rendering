...
public:
    ...
    virtual void setSamplerID(acd_int id) { samplerID = id; _mips.setSamplerID(id); }
    virtual acd_int getSamplerID() const { return samplerID; }
    acd_uint getSamplerID(acd_uint mipLevel) const { return _mips.getSamplerID(mipLevel); } 
