...
private:
    ...
    static bool setTextureTilingAlreadyCalled;
    static bool setDriverAlreadyCalled;
    ...
    void setSamplerID(acd_int id) { samplerID = id; }
    acd_int getSamplerID() const { return samplerID; }
};
