...
public:
    ...
    virtual acd_bool getEnable(acd_uint renderTargetID) const;
    ...
    void sync(bool forcePreload = false);
    ...
    void getBlendOptions(acd_uint rt, ACD_BLEND_OPTION &srcRGB, ACD_BLEND_OPTION &destRGB,
