...
bool TextureMipmap::setTextureTilingAlreadyCalled = false;
bool TextureMipmap::setDriverAlreadyCalled = false;
...
void TextureMipmap::setTextureTiling(acd_uint tileLevel1Sz, acd_uint tileLevel2Sz)
{
    ...
    //if ( !alreadyCalled )
    if ( !setTextureTilingAlreadyCalled )
    {
        //alreadyCalled = true;
        setTextureTilingAlreadyCalled = true;
...
void TextureMipmap::setDriver(GPUDriver* driver)
{
    ...
    //if ( !alreadyCalled )
    if ( !setDriverAlreadyCalled )
    {
        //alreadyCalled = true;
        setDriverAlreadyCalled = true;
        _driver = driver;
        GLOBALPROFILER_EXITREGION()
    }
}
...
TextureMipmap::TextureMipmap() : _data(0), _dataSize(0), _rowPitch(0), _planePitch(0), _mortonData(0), 
                                 ...
                                 _multisampling(false), _samples(1), samplerID(-1)
{
