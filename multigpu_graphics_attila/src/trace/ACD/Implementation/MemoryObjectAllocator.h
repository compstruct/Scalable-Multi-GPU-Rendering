...
public:
     ...
     */
    void syncGPU(MemoryObject* mo, bool forcePreload = false);
    void syncGPU(acd_uint gpuId, MemoryObject* mo, bool forcePreload = false);
     ...
     * @see syncGPU()
     */
    acd_bool syncGPU(MemoryObject* mo, acd_uint region, bool forcePreload = false);
    acd_bool syncGPU(acd_uint gpuId, MemoryObject* mo, acd_uint region, bool forcePreload = false);
...
private:
    ...
    void _update(MemoryObject* mo, MemoryObjectInfo* moi, acd_uint region, bool forcePreload = false);
    void _update(acd_uint gpuId, MemoryObject* mo, MemoryObjectInfo* moi, acd_uint region, bool forcePreload = false);

    void _dealloc(MemoryObject* mo, MemoryObjectInfo* moi, acd_uint region);

    void _alloc(MemoryObject* mo, MemoryObjectInfo* moi, acd_uint region, bool forcePreload = false);
    void _alloc(acd_uint gpuId, MemoryObject* mo, MemoryObjectInfo* moi, acd_uint region, bool forcePreload = false);
