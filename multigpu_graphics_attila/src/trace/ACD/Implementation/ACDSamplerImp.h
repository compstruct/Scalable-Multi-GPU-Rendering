...
public:
    ...
    virtual void sync(bool forcePreload = false);

    void sync(acd_uint gpuId, bool forcePreload = false);
...
private:
    ...
    void _syncTexture(bool forcePreload = false);
    void _syncTexture(acd_uint gpuId, bool forcePreload = false);
