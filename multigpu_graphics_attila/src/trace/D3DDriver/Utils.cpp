...
UINT get_start_vertex(D3DPRIMITIVETYPE type, UINT start, UINT start_primitive)
{
    u32bit start_vertex = start;
    switch(type)
    {
        case D3DPT_TRIANGLELIST:
            start_vertex = start + 3 * start_primitive;
            break;
        case D3DPT_TRIANGLESTRIP:
            start_vertex = start + start_primitive;
            break;
        case D3DPT_TRIANGLEFAN:
            start_vertex = start + start_primitive;
            break;
