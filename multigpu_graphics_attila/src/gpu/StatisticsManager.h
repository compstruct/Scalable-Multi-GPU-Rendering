...
private:
    ...
    // statistics managers for each GPU
    u32bit numGPUs;
    static StatisticsManager *sm;
    static StatisticsManager **sms;

public:

    static StatisticsManager& instance();

    void init(u32bit numGPUs);

    static StatisticsManager& instance(u32bit gpuId) { return *(sms[gpuId]); }

    void restart(u32bit numGPUs);
    ...
    void setPerCycleStream(std::ostream& os);
