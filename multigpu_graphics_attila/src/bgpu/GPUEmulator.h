...
private:
    ...
    private:
        ...
        void (*decompressionFunction) (u8bit *, u8bit *, u32bit, bool, u32bit, u32bit);   /**<  Pointer to the decompression function.  */
    ...
    u32bit gpuId;                    /**< Hack: GPU Id in multi-GPU architecture. */
...
public:
    ...
    GPUEmulator(u32bit gpuId, gpu3d::SimParameters simP, TraceDriverInterface *trDriver);

    bool emulationLoopEnd();
    /**
     *
