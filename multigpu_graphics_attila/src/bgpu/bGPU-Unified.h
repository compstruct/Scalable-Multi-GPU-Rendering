...
void runSimulation(bool debugMode, bool validationMode, u32bit instructionsToSchedulePerCycle, bool vectorScalarALU);

void parseVertexesInKDTree(std::ifstream &kdTree, u32bit numGPUs);
